...
public class VideoRecorder_utlity extends ScreenRecorder
{
    ...
    static String directory = "TestRun_" + dateFormat.format(new Date());
    public static File dir = new File("./automationrecordings/"+directory);
    ...
    public static void startRecord(String methodName) throws Exception {
        dir.mkdirs();
        File file = new File(dir.toString()); //Path where vidoe recording would be stored inside project
        ...
        screenRecorder = new VideoRecorder_utlity(gc, captureSize,
                ...
                new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE,
                        ...
                        Rational.valueOf(30), QualityKey, 1.0f, KeyFrameIntervalKey, 30 * 60),
